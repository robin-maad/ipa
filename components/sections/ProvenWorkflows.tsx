  ...
  const workflows = [
    {
      ...
      description:
        'Automatisierte Verarbeitung von Jahresabschlussdokumenten',
      steps: [
        'Dokumenteneingang erkennen',
    ...
    },
    {
      icon: UserPlus,
      title: 'Neuer Mandant',
      description: 'Onboarding-Prozess für neue Mandate',
      steps: [
        'Dokumentensammlung',
        'Datenextraktion',
      ...
      impact: '8-10 Stunden → 1 Stunde',
      color: 'from-teal-500 to-teal-600',
      bgColor: 'from-teal-100 to-teal-200',
    },
    {
      icon: FileText,
      title: 'Monatsbuchhaltung',
      description: 'Laufende Buchführung und Belegverarbeitung',
      steps: [
